...
for (let iii = 0; iii < parcours.length; iii++) {
    ...
    generate_parc += ' <article style=" background: radial-gradient(circle, rgba(255,255,255,1) 25%, rgba(255,255,255,0) 100%), url(' + img_link[iii] + ' )" > <img src=' + img_link[iii] + ' alt="' + parci.alt + '"></article><article><h3>' + parci.title + '</h3>';
